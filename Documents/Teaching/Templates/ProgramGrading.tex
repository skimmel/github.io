...
\begin{itemize}
\item \textbf{Rough Draft:} You should submit something that shows a hour or two spent working on the project.
...
& 
& 
Shows an hour or two spent on the project.& 
Something submitted, but not clear if any thought was really given.& 
